...
export default function Footer(){
    return <footer className="container flex flex-col bg-black text-zinc-400 py-10 gap-10">
            <div className="flex flex-col md:flex-row items-center md:items-start justify-between text-center gap-5 md:gap-0 md:text-left">
                ...
                <div className="flex flex-col gap-1">
                    <span className="text-2xl font-bold text-white pb-2">Contacto</span>
                    <span className="text-sm">support@barbabrutal.com.ao</span>
            ...
            <div className="flex flex-col md:flex-row items-center gap-1.5 justify-between text-zinc-300">
