            ...
            {[1, 2, 3].map((i) => (
              <SwiperSlide key={i}>
                <div className="relative w-full h-full">
                  ...
                  />
                  <div className="absolute bottom-0 w-full bg-black/60 px-6 py-6">
                    <p className="text-white text-base md:text-2xl font-light text-center leading-relaxed">
                      Plataforma segura e confiável para gestão de logística e mobilidade.<br />
                      Milhares de utilizadores confiam em nós todos os dias.
                    </p>
                  </div>
                </div>
              </SwiperSlide>
