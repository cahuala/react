            ...
            {[4, 5, 6].map((i) => (
              <SwiperSlide key={i}>
                <div className="relative w-full h-full">
                  <img
                    src={`/logistica/logistica-${i}.jpg`}
                    alt={`Slide ${i}`}
                    className="w-full h-full object-cover lg:rounded-r-3xl"
                  />
                  <div className="absolute bottom-0 w-full bg-black/60 px-6 py-8">
                  <p className="text-white text-lg md:text-3xl font-light text-center leading-relaxed">
                    Plataforma segura e inteligente para gestão de logística e mobilidade interprovincial.
                    Otimize entregas, reduza custos e acompanhe tudo em tempo real.
                    Mais de <span className="font-semibold text-yellow-400">10.000 utilizadores</span> confiam diariamente nos nossos serviços para transportar o que importa.
                  </p>
                </div>
                </div>
              </SwiperSlide>
