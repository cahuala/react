...
// ✅ Corrigido: agora DropdownMenu é JSX-compatible
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn("cursor-pointer select-none rounded-sm px-2 py-1.5 text-sm hover:bg-zinc-100", inset && "pl-8", className)}
    {...props}
  />
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn("relative flex select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm hover:bg-zinc-100", className)}
    checked={checked}
    {...props}
  >
