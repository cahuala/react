...
import FormSolicitacao from '@/components/dashboard/pages/delivery/FormDelivery'
...
export default function Page() {
  ...
  return (
    <div className="flex flex-col px-4 md:px-8 py-6">
      {/* Título */}
      <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Registrar Encomendas</h1>
